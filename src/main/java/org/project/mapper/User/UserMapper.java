...
public interface UserMapper {
	...
	public int mailCheck(@Param("ranStr") String ranStr); //이메일 본인인증
	public int isMailExist(String email); //이메일 본인인증
	...
	public int ranStr(@Param("checkStr") String checkStr, @Param("email")String email);//본인인증 메일 발송용 난수 생성
