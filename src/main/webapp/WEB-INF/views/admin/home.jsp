...
<form id="introForm" action="/admin/home" method="post">
	...
	<div class="row">		
		...
		<div id="introCol12" class="col-lg-12">
			<div style="width: 75%;">
				<h1 id="introPageHeader" class="page-header">
					<i class="fa fa-bookmark-o"></i>&nbsp;&nbsp;<input class="form-control"id="title" name="title_title" style="height:50px; width:82%; font-size: 36px" placeholder="제목을 입력해주세요" value="${home.title_title}">
		...
		<p class="mb-4">
			<label>소개글</label>
	<textarea class="form-control" name="title_intro" style="width:80%" placeholder="간단한 페이지 소개글 입력"><c:out value="${home.title_intro}"/></textarea>
		</p>        			
	</div>
	...
	<div class="form-group" style="margin-left: 10px;">	
		...
		<div style="display: flex; align-items: center;">		
			<div style="width:73%; display: flex; align-items:center;">
				<input class="form-control" name="map_title" placeholder="여기는 어떤 곳인가요?" style="width:89%" value="${home.map_title}"> 
	...
	<div id="map" style="border-radius:5px;  width:80%; height:350px; margin: 0 0 20px 10px;"></div>
	<div style="display: flex; justify-content: space-between; margin-left:10px;">
		<div class="form-group" style="width:15%">
			<label>마커제목</label><input class="form-control" name="map_caption" style="width: 90%" placeholder="장소설명" value="${home.map_caption}">
		...
		<div class="form-group" style="width:75%">
			...
			<div style="width: 46.7%">
				<input name="map_address" class="form-control" id="address_kakao" placeholder="주소입력" value="${home.map_address}" readonly>&nbsp;
			</div>
			<div style="width: 30%; margin-left: 5px">
				<input class="form-control" name="map_addressdetail" placeholder="상세주소" value="${home.map_addressdetail}">&nbsp;
	...
	<div class="form-group" style="margin-left: 10px;">
		<label>장소소개</label>
<textarea class="form-control" name="map_intro" placeholder="이 장소는 어떤 곳인지 알려주세요"><c:out value="${home.map_intro}"/></textarea>
	</div>	
	<!-- 본문-->
	<div class="panel panel-default" style="margin-left: 10px;">
		<div class="panel-heading">	Footer 소개란 </div>
		<div class="panel-body">
<textarea class="form-control" name="intro"><c:out value="${home.intro}"/></textarea>
		</div>				
	</div>	
