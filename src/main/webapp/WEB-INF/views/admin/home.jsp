...
<div class="row">		
	...
	<div id="introCol12" class="col-lg-12">
		<div style="width: 75%;">
			<h1 id="introPageHeader" class="page-header">
				<i class="glyphicon glyphicon-console" style="font-size:28px;"></i><b> Console.log(YH)</b><i class="glyphicon glyphicon-menu-right"></i>
				<input class="form-control" id="title" name="title" style="height:50px; width:82%; font-size: 36px" placeholder="제목을 입력해주세요" value="<c:out value='${home.title}'/>">				
			</h1>
		</div>
	...
	<p class="mb-4">
		<i class="fa fa-comments-o fa-fw"></i><label>페이지소제목</label>
<textarea class="form-control" name="tscript" style="width:73.5%" placeholder="간단한 페이지 소개글 입력"><c:out value="${home.tscript}"/></textarea>
	</p>       			
	<!-- 파일업로드 -->
	<div class="form-group" style="margin-left: 20px; width: 72%;">
	...
	<div class="form-group" style="margin-left: 20px;">	
		<i class="fa fa-linkedin fa-fw"></i><label>장소명</label>
		<div style="display: flex; align-items: center;">		
			<div style="width:95%; display: flex; align-items:center;">
				<input class="form-control" name="map" placeholder="여기는 어떤 곳인가요?" style="width:89%" value="${home.map}">				
			</div>
			<div style="width: 20%;">
	...
	<div id="map" style="border-radius:5px;  width:88.3%; height:350px; margin-left:20px"></div>
	<div style="display: flex; justify-content:space-between; margin: 20px 0 5px 20px; height:50px">
		<div style="width:15%;">
			<i class="fa fa-comment-o fa-fw"></i><label>마커제목</label><input class="form-control" name="caption" style="width: 90%; height:30px;" placeholder="장소설명" value="${home.caption}">			 
		</div>
		<div style="width:75%;">
			<i class="fa fa-thumb-tack fa-fw"></i><label>주소</label>
			<div style="display: flex; align-items: flex-start;">
				<div style="width: 46.7%;">
					<input name="address" class="form-control" id="address_kakao" style="height: 30px;" placeholder="주소입력" value="${home.address}" readonly>
				</div>
				<div style="width: 30%; margin-left: 5px;">
					<input class="form-control" name="addressdetail" placeholder="상세주소" style="height: 30px;" value="${home.addressdetail}">						
				</div>
				<div style="width: 20%; margin-left: 5px">
					<button id="searchBtn" class="btn btn-default" style="height: 30px">Mark</button>
				</div>
			</div>
		</div>
	</div>							
	<div class="form-group" style="margin: 20px;">
		<i class="fa fa-comments-o fa-fw"></i><label>장소소개</label>
<textarea class="form-control" name="mscript" placeholder="이 장소는 어떤 곳인지 알려주세요" style="width: 91.5%"><c:out value="${home.mscript}"/></textarea>
	</div>	
	<!-- 본문-->
	<div class="panel panel-default" style="margin: 50px 0 0 20px;">
		<div class="panel-heading"><i class="fa fa-align-left fa-fw"></i> <label>커뮤티니 정보</label></div>
		<div class="panel-body">
<textarea class="form-control" rows="2" name="intro"><c:out value="${home.intro}"/></textarea>
		</div>				
	</div>	
	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
	<input type="hidden" name="boardtype" value="1">
	<input type="hidden" name="attachList.boardtype" value="1">
	</form>			
	<!-- 이동용 화살표 -->
