	...
	<div id="introCol12" class="col-lg-12">
		<div style="width: 75%;">
			<h1 id="introPageHeader" class="page-header">
				...
				<input class="form-control" style="height:50px; width:50%; font-size: 36px" id="title" name="title" placeholder="제목을 입력해주세요" value="<c:out value='${intro.title}'/>">							
			</h1>
		</div>
...
<textarea class="form-control" name="tscript" style="width:73.5%" placeholder="간단한 페이지 소개글 입력"><c:out value="${intro.tscript}"/></textarea>
	</p>
	<!-- 파일업로드 -->
	...
	<div class="form-group" style="margin-left: 20px;">	
		...
		<div style="display: flex; align-items: center;">		
			<div style="width:95%; display: flex; align-items:center;">
				<input class="form-control" name="map" placeholder="여기는 어떤 곳인가요?" style="width:89%" value="${intro.map}">				
			</div>
			<div style="width: 20%;">
	...
	<div style="display: flex; justify-content:space-between; margin: 20px 0 5px 20px; height:50px">
		<div style="width:15%;">
			<i class="fa fa-comment-o fa-fw"></i><label>마커제목</label><input class="form-control" name="caption" style="width: 90%; height:30px;" placeholder="장소설명" value="${intro.caption}">			 
		</div>
		<div style="width:75%;">
			<i class="fa fa-thumb-tack fa-fw"></i><label>주소</label>
			<div style="display: flex; align-items: flex-start;">
				<div style="width: 46.7%;">
					<input name="address" class="form-control" id="address_kakao" style="height: 30px;" placeholder="주소입력" value="${intro.address}" readonly>
				</div>
				<div style="width: 30%; margin-left: 5px;">
					<input class="form-control" name="addressdetail" placeholder="상세주소" style="height: 30px;" value="${intro.addressdetail}">						
				</div>
...
<textarea class="form-control" name="mscript" placeholder="이 장소는 어떤 곳인지 알려주세요" style="width: 91.5%"><c:out value="${intro.mscript}"/></textarea>
	</div>	
	<!-- 본문-->
	<div class="panel panel-default" style="margin: 50px 0 0 20px;">
		<div class="panel-heading"><i class="fa fa-align-left fa-fw"></i> <label>소개</label></div>
		<div class="panel-body">
<textarea class="form-control" rows="10" name="intro"><c:out value="${intro.intro}"/></textarea>
		</div>				
	</div>	
