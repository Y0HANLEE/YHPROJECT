...
<title>Console.log(YH)_게시글수정</title>
...
<div class="row">
	<div id="userCol12" class="col-lg-12">
		<div class="panel panel-default">
			<!-- 본문제목 -->
			<div class="panel-heading">	사진게시판 - 게시글 수정</div>			
			<!-- 본문내용 -->	
			<div class="panel-body">
				<form role="form" action="/album/modify" method="post">
					...
					<div class="form-group" style="display: flex;justify-content: space-between;">
						...
						<div>
							<i class="fa fa-check fa-fw"></i><label>등록일</label> <fmt:formatDate pattern="YY/MM/dd hh:mm:ss" value="${album.regdate}"/>&nbsp;&nbsp;&nbsp;
							<i class="fa fa-refresh fa-fw"></i><label>수정일</label> <fmt:formatDate pattern="YY/MM/dd hh:mm:ss" value="${album.updatedate}"/>
						</div>						
					</div>
					<hr>					
					<div class="form-group" style="display: flex; justify-content: space-between;">
		...
		$.getJSON("/album/getAttachList", {ano:ano}, function(arr){
			...
			$(arr).each(function(i, attach){
				...
				if(attach.fileType){					
					...
					str += "<img src='/display?fileName="+fileCallPath+"'> <span id='img'>"+attach.fileName+"</span> "; //파일명
